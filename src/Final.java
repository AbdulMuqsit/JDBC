...
//        try{
//
//            String q="create table StudentDetails(RollNo int,name varchar(30),Age int,Address varchar(30),PhoneNo int)";
//
...
//        int inserted=0;
//        try{
//            String q="insert into StudentDetails(RollNo,name,Age,Address,PhoneNo) values (?,?,?,?,?) ";
...
//        try{
//            String q="update StudentDetails set name=? where RollNo=?";
//            BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
...
//        int deleted=0;
//        try{
//            String q="delete from StudentDetails where RollNo=3";
//
//            Statement stmt=con.createStatement();
